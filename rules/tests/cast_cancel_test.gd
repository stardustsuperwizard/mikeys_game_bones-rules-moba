...
##
## Channel coverage lives in channel_test.gd. The two were one suite until this
## file passed the gdlint max-file-lines cap; the split is along the cast/channel
## seam, and the fixture and actor helpers below are duplicated there verbatim
## rather than shared, matching how crowd_control_test.gd and
