...
static func string_to_state(state_name: String) -> int:
	match state_name:
		...
		"BASIC_ATTACK_WINDUP": return BASIC_ATTACK_WINDUP
		"BASIC_ATTACK_RECOVERY": return BASIC_ATTACK_RECOVERY
		"ABILITY_CAST": return ABILITY_CAST
		"ABILITY_CHANNEL": return ABILITY_CHANNEL
		"DASHING": return DASHING
		"AIRBORNE": return AIRBORNE
		"CROWD_CONTROLLED": return CROWD_CONTROLLED
		"DEAD": return DEAD
		_: return -1
